    ...
    <div className="product-catalogue">
      ...
      <div className="catalogue-categories">
        <div className="category-card">
          ...
          <p>Browse our range of home care manufacturing solutions</p>
          <Link to="/home" className="category-link">View Products</Link>
        </div>
      ...
      <div className="catalogue-downloads">
        ...
        <div className="download-options">
          <a href="/downloads/personal-care-catalogue.pdf" className="download-btn">home Care Catalogue</a>
