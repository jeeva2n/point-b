...
if (contactOpen && contactPanelRef.current && !contactPanelRef.current.contains(event.target) && !event.target.closest('.contact-dropdown-trigger')) {
...
<div className="header-container">
    ...
    >
      ...
      <div className="contact-company-info">
        <h3 className="company-title">Partner Company</h3>
        <p className="company-subtitle">Secondary Company Description • Tagline Goes Here • Subtitle</p>
        <p className="contact-label">Address</p>
        <p>123 Business Park,<br />Example Street, Floor 4,<br />City Name, State 000000<br />Country</p>
        <p className="contact-label">Phone</p><p>+91 98765 43210</p>
        <p className="contact-label">Email</p><p>contact@partnercompany.com</p>
        <p className="contact-label">Hours</p><p>Mon-Sat: 9:00 AM - 6:00 PM</p>
        <p className=""></p>
      </div>
